...
- [4. Ingegneria antisismica](#4-ingegneria-antisismica)
    - [RISCHIO SISMICO COS'È?](#rischio-sismico-cos-é)
    	- [PERICOLOSITÁ](#pericolosità)
    	- [VULNERABILITÁ](#vulnerabilità)
    	- [ESPOSIZIONE](#esposizione)
    	- [RISPOSTA SISMICA DELLE STRUTTURE](#risposta-sismica-delle-strutture)
    - [AGIBILITÀ E VULNERABILITÀ](#agibilita-e-vulnerabilità)
    	- [PERIZIA DI AGIBILITÀ](#perizia-di-agibilità)
    	- [PERIZIA DI VULNERABILITÀ](#perizia-di-vulnerabilità)
    	- [QUAL È IL RAPPORTO TRA AGIBILITÀ E VULNERABILITÀ?](#qual-é-il-rapporto-tra-agibilità-e-vulnerabilità)
