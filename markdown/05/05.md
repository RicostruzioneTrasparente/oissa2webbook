...
**La domanda di contributo per l'intervento sull'aggregato costituito da più UMI** può essere presentata dall'amministratore di ciascun consorzio costituito tra proprietari dell'UMI: la domanda comprende quanto stabilito per ogni edificio e deve essere corredata da un'apposita scheda informativa riepilogativa degli interventi dell'aggregato, predisposta secondo il modello reperibile sul [sito web del Commissario](sisma2016.gov.it).